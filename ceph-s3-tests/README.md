...
[`data-tools`](data-tools/README.md) runs the Python data tools, PyIceberg, delta-rs, Polars, Lance, LanceDB, s3fs
and pandas, against the same jar, in a uv project of its own.
