...
public enum S3ErrorCode {
  ...
  MalformedXML("MalformedXML", 400, "The XML you provided was not well-formed or did not validate against our published schema."),
  ...
  MissingSecurityHeader("MissingSecurityHeader", 400, "Your request was missing a required header."),
  ...
  NoSuchObjectLockConfiguration("NoSuchObjectLockConfiguration", 404, "The specified object does not have a ObjectLock configuration."),
  ...
  NoSuchWebsiteConfiguration("NoSuchWebsiteConfiguration", 404, "The specified bucket does not have a website configuration"),
  ...
  ObjectLockConfigurationNotFoundError("ObjectLockConfigurationNotFoundError", 404, "Object Lock configuration does not exist for this bucket"),
  OwnershipControlsNotFoundError("OwnershipControlsNotFoundError", 404, "The bucket ownership controls were not found"),
  ...
  SignatureDoesNotMatch("SignatureDoesNotMatch", 403, "The request signature we calculated does not match the signature you provided."),
